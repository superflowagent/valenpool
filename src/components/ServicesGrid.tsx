        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {services.map((s) => {
            ...
            return (
              <article
                key={s.title}
                className="bg-white rounded-lg p-6 border border-transparent hover:shadow-lg hover:border-primary transition-transform transform hover:-translate-y-1 cursor-default select-none"
              >
